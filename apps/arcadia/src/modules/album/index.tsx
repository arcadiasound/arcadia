        ...
        {album && (
          ...
          >
            ...
            <Flex
              ...
              justify="between"
            >
              <Flex css={{ height: "100%" }} direction="column" justify="between" gap="10">
                <Flex align="center" gap="3">
                  ...
                  <Box>
                    <StyledTypography size="1">{album.releaseType}</StyledTypography>
              ...
              {album.genre ||
                (album.topics && (
                  <Flex direction="column" gap="3" align="end">
                    {album.genre && <StyledTypography size="1">electronic</StyledTypography>}
                    {album.topics && (
                      <Flex
                        as="ul"
                        wrap="wrap"
